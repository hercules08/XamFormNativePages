...
using Xamarin.Forms;
using Xam = Xamarin.Forms.Platform.Android;
using XamFormsNativePages;
using XamFormsNativePages.Droid;

[assembly: ExportRenderer(typeof(MainPage),typeof(MainPageRenderer))]
public class MainPageRenderer:Xam.PageRenderer
{
    ...
    protected override void OnElementChanged(Xam.ElementChangedEventArgs<Page> e)
    {
